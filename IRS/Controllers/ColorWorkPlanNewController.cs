...
{
    public class ColorWorkPlanNewController : ApiControllerBase
    {
        private readonly IColorWorkPlanNewService _service;

        public ColorWorkPlanNewController(IColorWorkPlanNewService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] ColorWorkPlanNewDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPost]
        public async Task<ActionResult> UpdateAsync([FromBody] ColorWorkPlanNewDto model)
        {
