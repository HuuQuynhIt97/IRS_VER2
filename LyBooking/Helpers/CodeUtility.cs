...
namespace IRS.Helpers
{
   ...
   (this IEnumerable<TSource> source, Func<TSource, TKey> keySelector)
        ...
        public static DateTime ToDateTime(this object value)
        {
            ...
            string[] formats = 
                {
                    "d/M/yyyy", "dd/MM/yyyy", "d/M/yyyy HH:mm:ss", "d/M/yyyy HH:mm", "dd/MM/yyyy HH:mm", "HH:mm:ss", "HH:mm",
                    "d-M-yyyy", "dd-MM-yyyy", "MM-dd-yyyy","MM-dd-yy", "yyyy-MM-dd", "d-M-yyyy HH:mm:ss", 
                    "d-M-yyyy HH:mm", "dd-MM-yyyy HH:mm", "HH:mm:ss", "HH:mm"
