...
import { StockInChemical } from './../../../../_core/_model/stock/stockInChemical';
import { StockInChemicalService } from './../../../../_core/_service/stock/stock-in-chemical.service';
...
@Component({
  selector: 'app-stock-in-chemical',
  templateUrl: './stock-in-chemical.component.html',
  styleUrls: ['./stock-in-chemical.component.scss']
})
export class StockInChemicalComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  inkColor: StockInChemical = {} as StockInChemical
  setFocus: any;
  ...
  update() {
   this.alertify.confirm4(
      ...
      this.alert.updateMessage,
      () => {
        this.service.update(this.inkColor as StockInChemical).subscribe(
          (res) => {
            if (res.success === true) {
              this.alertify.success(this.alert.updated_ok_msg);
              this.loadData();
