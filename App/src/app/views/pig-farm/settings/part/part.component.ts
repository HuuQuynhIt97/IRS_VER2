...
export class PartComponent extends BaseComponent implements OnInit, OnDestroy  {
  ...
  update() {
    this.alertify.confirm4(
       ...
       () => {
         this.service.update(this.model as Part).subscribe(
           (res) => {
             if (res.success === true) {
