...
@Component({
  selector: 'app-shoe-glue-child',
  templateUrl: './shoe-glue-child.component.html',
  styleUrls: ['./shoe-glue-child.component.css']
})
export class ShoeGlueChildComponent extends BaseComponent implements OnInit, OnDestroy {
